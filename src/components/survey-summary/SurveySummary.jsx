                            ...
                            <div className="participant-name-looped-360">
                                ...
                                <div className="participants_bg" style={{ backgroundColor: '#174A6D', padding: "50px 30px", marginTop: '25px' }}>
                                    <div className="row">
                                        ...
                                        <div className="col-md-12 col-lg-6">
                                            <p className="text-white font-frank mb-4" style={{ fontSize: '20px' }}>
                                ...
                                <div className="summary_graph_top" style={{ backgroundColor: '#F5F5F5', padding: '10px 30px' }}>
                                ...
                                <h3 className="text-custom-color font-frank fw-medium mt-5" style={{ fontSize: '25px', lineHeight: '40px' }}>
                                    Open-Ended Comments
                                </h3>
